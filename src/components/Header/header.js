    ...
    <header className="page_header">
      <div className="slides">
        <div className="slides_image">
          <Slider {...slickHeader} ref={sliderRef}>
          ...
          <div className="slides_title">
            ...
            <h1>
              {t('header.Welcome Home')} <br />
              <span>{t('header.To')}</span> {t('header.Luxury')}
            </h1>
            <h4 className="slides_title_h4">{t('header.Book a consultation')}</h4>
          </div>
          <div className="slides_messenger">
            <a className="messenger" href="/">
              <img src={messanger} alt="messangers" />
            </a>
          </div>
          <div className="slides_button">
            <p className="slides_button_prev" onClick={() => handleSlideClick(0)} >
              {t('header.Prev')}
            </p>
            <p className="slides_button_next" onClick={() => handleSlideClick(2)}>
              {t('header.Next')}
            </p>
          </div>
          <div className="slides_container">
            ...
            <button className={`number_two ${activeSlide === 1 ? 'active' : ''}`} onClick={() => handleSlideClick(1)}>
              <h5 className="two">02</h5>
              <p className="number_text_two">{t('header.Lorem Ipsum')}<br />{t('header.Dolorem apset')}</p>
            </button>
            <button className={`number_three ${activeSlide === 2 ? 'active' : ''}`} onClick={() => handleSlideClick(2)}>
